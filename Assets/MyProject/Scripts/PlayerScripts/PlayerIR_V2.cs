...
public class PlayerIR_V2 : Agent
{
    // 各種パラメータ
    ...
    public override void Initialize()
    {
        ...
        posGoal = GameObject.FindWithTag("CheckPoint1").transform.position;
    ...
    public override void OnEpisodeBegin()
    {
        ...
        initRot = Quaternion.Euler(0.0f, Random.RandomRange(0.0f, 360.0f), 0.0f);
        
        // 初期化処理
        transform.position = initPos;
        transform.rotation = initRot;
        
        toGoal = Vector3.Distance(playerRb.transform.position, posGoal);
        prevToGoal = toGoal;
    ...
    public void OnCollisionStay(Collision other)
    {
        ...
        {
            // 衝突ペナルティの計算
            AddReward(-1.0f * 0.00085f);
            fitness4 += -1.0f * 0.00085f;
            collisionValue = 1.0f;
        }
    }
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        {
            AddReward(1.0f * 0.002f);
            fitness2 += 1.0f * 0.002f;
        }
