...
public class PlayerV3 : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        // float postureY = 1.0f/(Mathf.Abs(sensorRight.transform.position.y - sensorLeft.transform.position.y) + 1.0f);
        // float postureX = 1.0f/(Mathf.Abs(sensorTop.transform.position.x - sensorBottom.transform.position.x) + 1.0f);
        // float postureZ = 1.0f/(Mathf.Abs(sensorTop.transform.position.z - sensorBottom.transform.position.z) + 1.0f);
        
        // float postureReward = postureX + postureY + postureZ;
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        // continuousAct[3] = 0.0f;
        // continuousAct[4] = 0.0f;
